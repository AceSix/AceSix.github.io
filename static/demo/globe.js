...
function make_earth() {
    ...
    function init() {
        ...
        var light6 = new THREE.PointLight(0xffffff, 0.6, 4000);
        light6.position.set(0, 0, -300);
        scene.add(light6);

        var light7 = new THREE.PointLight(0xffffff, 0.6, 4000);
    ...
    function createSun() {
        ...
        sun.position.set(-8000, 1000, 2000);
    ...
    function add_mark() {
        ...
        var mark = new THREE.Sprite(
            new THREE.SpriteMaterial({
                map: texture
            })
        )
        mark.position.set(200, 200, 200);
        scene.add(mark)
    }
    add_mark();
    /**
