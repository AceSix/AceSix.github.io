 ...
 * @LastEditors: AceSix
 * @LastEditTime: 2021-06-30 16:56:44
...
!(function (t) {
	...
	function (t, e, i) {
		...
		(n.options = {
			...
			bgColorHover: "#0ff",
			bgColor: "#099",
			sprite: { n: 16, color: "#099", lineWidth: 3 },
			w: 1200,
			h: 400,
		}),
			(n = d.extend(n, {})),
			...
			(n.prototype.initDom = function () {
				...
				for (var k = 0; y > k; k++) {
					...
					h.css({
						...
						opacity: 0,
						transition:
							"opacity 0.3s ease-in-out, transform 0.3s ease-in-out, background-color 0.5s ease-in-out, color " +
							(1 + 0.5 * r()) +
							"s ease-in-out",
					});
				}
	...
	function (t, e, i) {
		...
		(n.prototype.setMaxListeners = function (t) {
			...
			(n.prototype.emit = function () {
				...
				if (r(e)) {
					for (
						var i = arguments.length, n = new Array(i - 1), o = 1;
						i > o;
						o++
					)
						n[o - 1] = arguments[o];
